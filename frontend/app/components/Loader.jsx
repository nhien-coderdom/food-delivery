export default function Loader() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-green-500/40 backdrop-blur-sm">
      <div role="status" className="flex flex-col items-center">
        <svg
          aria-hidden="true"
          className="w-10 h-10 text-gray-200 animate-spin fill-green-500"
          viewBox="0 0 100 101"
        ...
        <span className="mt-3 text-sm text-gray-800 font-medium">
          Loading...
        </span>
      </div>
    </div>
